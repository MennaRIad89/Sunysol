TRANSLATIONS = {
    'en': {
        ...
        'combo_tour': 'Dubai Full Day Modern & Classic Tour',
        'combo_description': 'The ultimate Dubai experience combining both classic heritage sites and modern attractions in one comprehensive day tour.',
        'marina_cruise_tour': 'Dubai Marina Cruise Experience',
        'marina_cruise_description': 'Sail through Dubai Marina\'s stunning waterfront aboard a traditional dhow or luxury yacht with entertainment and dining options.',
        'desert_safari_tour': 'Desert Safari Tour (Evening Experience)',
        'desert_safari_description': 'Adventure into the Arabian desert with dune bashing, camel rides, cultural shows, and traditional BBQ dinner under the stars.',
        ...
        'agency_hero_title': 'Partner With Us – For Travel Agencies',
        'agency_hero_subtitle': 'Your Trusted Local Expert in the UAE',
        'agency_intro_lead': 'Looking for a reliable, certified, Spanish-speaking guide in the UAE to elevate your clients\' travel experience? You\'re in the right place.',
        'agency_intro_description': 'With over 9 years of experience working with leading agencies across Spain and Latin America, I specialize in delivering seamless, high-quality tours tailored to your client\'s needs — from individual travelers to large corporate or student groups.',
        'agency_what_i_offer': 'What I Offer',
        'agency_offer_guided_tours': 'Fully Guided Tours',
        'agency_offer_guided_tours_desc': 'Complete Spanish-language tours across Dubai, Abu Dhabi & the Northern Emirates.',
        'agency_offer_group_management': 'Group Management',
        'agency_offer_group_management_desc': 'Full logistics, coordination, and transport for groups of all sizes.',
        'agency_offer_vip_private': 'VIP & Private',
        'agency_offer_vip_private_desc': 'Premium experiences for your most discerning clients.',
        'agency_offer_attraction_bookings': 'Attraction Bookings',
        'agency_offer_attraction_bookings_desc': 'Desert safaris, museums, cruises, parks, and more.',
        'agency_offer_licensed_vehicles': 'Licensed Vehicles',
        'agency_offer_licensed_vehicles_desc': 'Cars, vans, and luxury buses to suit your needs.',
        'agency_offer_custom_itineraries': 'Custom Itineraries',
        'agency_offer_custom_itineraries_desc': 'Tailor-made experiences that match agency requirements.',
        'agency_offer_ground_support': 'On-Ground Support',
        'agency_offer_ground_support_desc': 'Immediate assistance for changes or emergencies.',
        'agency_why_partner': 'Why Partner With Me',
        'agency_why_trusted': 'Trusted by agencies in the UAE, Spain & Latin America',
        'agency_why_local_knowledge': 'Deep local knowledge with cultural sensitivity',
        'agency_why_professional': 'Responsive, reliable, and professional',
        'agency_why_certified': 'Certified in both Dubai and Abu Dhabi',
        'agency_why_network': 'Strong network of licensed guides & trusted suppliers',
        'agency_work_together': 'Let\'s Work Together',
        'agency_work_together_desc': 'Ready to discuss a partnership? I\'d love to hear from you.',
        'agency_contact_collaboration': 'Contact for Agency Collaboration',
        'agency_return_home': 'Return to Home',
    ...
    'es': {
        ...
        'combo_tour': 'Tour Completo de Dubái Moderno y Clásico',
        'combo_description': 'La experiencia definitiva de Dubái combinando sitios del patrimonio clásico y atracciones modernas en un tour completo de un día.',
        'marina_cruise_tour': 'Experiencia de Crucero por Dubai Marina',
        'marina_cruise_description': 'Navega por la impresionante costa de Dubai Marina a bordo de un dhow tradicional o yate de lujo con entretenimiento y opciones gastronómicas.',
        'desert_safari_tour': 'Safari en el Desierto (Experiencia Vespertina)',
        'desert_safari_description': 'Aventúrate en el desierto árabe con paseos por dunas, paseos en camello, espectáculos culturales y cena BBQ tradicional bajo las estrellas.',
        ...
        'agency_hero_title': 'Colabora Con Nosotros – Para Agencias de Viajes',
        'agency_hero_subtitle': 'Tu Experto Local de Confianza en los EAU',
        'agency_intro_lead': '¿Buscas un guía confiable, certificado y que hable español en los EAU para elevar la experiencia de viaje de tus clientes? Estás en el lugar correcto.',
        'agency_intro_description': 'Con más de 9 años de experiencia trabajando con agencias líderes en España y América Latina, me especializo en ofrecer tours fluidos y de alta calidad adaptados a las necesidades de tus clientes — desde viajeros individuales hasta grandes grupos corporativos o estudiantiles.',
        'agency_what_i_offer': 'Lo Que Ofrezco',
        'agency_offer_guided_tours': 'Tours Completamente Guiados',
        'agency_offer_guided_tours_desc': 'Tours completos en español por Dubái, Abu Dhabi y los Emiratos del Norte.',
        'agency_offer_group_management': 'Gestión de Grupos',
        'agency_offer_group_management_desc': 'Logística completa, coordinación y transporte para grupos de todos los tamaños.',
        'agency_offer_vip_private': 'VIP y Privados',
        'agency_offer_vip_private_desc': 'Experiencias premium para tus clientes más exigentes.',
        'agency_offer_attraction_bookings': 'Reservas de Atracciones',
        'agency_offer_attraction_bookings_desc': 'Safaris por el desierto, museos, cruceros, parques y más.',
        'agency_offer_licensed_vehicles': 'Vehículos Licenciados',
        'agency_offer_licensed_vehicles_desc': 'Autos, camionetas y autobuses de lujo para satisfacer tus necesidades.',
        'agency_offer_custom_itineraries': 'Itinerarios Personalizados',
        'agency_offer_custom_itineraries_desc': 'Experiencias hechas a medida que se adaptan a los requisitos de la agencia.',
        'agency_offer_ground_support': 'Soporte en Destino',
        'agency_offer_ground_support_desc': 'Asistencia inmediata para cambios o emergencias.',
        'agency_why_partner': 'Por Qué Colaborar Conmigo',
        'agency_why_trusted': 'De confianza para agencias en los EAU, España y América Latina',
        'agency_why_local_knowledge': 'Conocimiento local profundo con sensibilidad cultural',
        'agency_why_professional': 'Responsiva, confiable y profesional',
        'agency_why_certified': 'Certificada en Dubái y Abu Dhabi',
        'agency_why_network': 'Red sólida de guías licenciados y proveedores de confianza',
        'agency_work_together': 'Trabajemos Juntos',
        'agency_work_together_desc': '¿Listo para discutir una colaboración? Me encantaría escucharte.',
        'agency_contact_collaboration': 'Contactar para Colaboración de Agencia',
        'agency_return_home': 'Regresar al Inicio',
